...
VERSION: v2026_06_19_contact_detail_compact
...
export async function renderContactsGrid(containerId, context = {}) {
    ...
    container.innerHTML = `
        <style>
            ...
            .contact-detail-card { background:#ffffff; max-width:350px; margin:16px auto; padding:14px; border-radius:14px; box-shadow:0 4px 18px rgba(0,0,0,0.08); text-align:center; display:none; }
            .contact-detail-title { color:#003b73; font-size:24px; font-weight:bold; margin-bottom:2px; text-align:center; }
            .contact-detail-subtitle { color:#003b73; font-size:13px; font-weight:bold; margin-bottom:10px; letter-spacing:2px; text-align:center; }
            .contact-detail-img { width:70px; height:70px; border-radius:50%; object-fit:cover; background:#dbe5ef; margin:0 auto 8px; display:block; }
            ...
            .contact-detail-link { color:#00509d; font-size:15px; font-weight:bold; text-decoration:underline; cursor:pointer; background:none; border:none; padding:0; text-align:center; }
            .contact-detail-add-project-btn { background:#22a843; color:white; border:none; border-radius:9px; width:100%; min-height:44px; font-size:14px; font-weight:bold; cursor:pointer; margin:0 0 10px; }
            .contact-detail-button-row { display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px; }
            .contact-detail-action-btn { background:#003b73; color:white; border:none; border-radius:9px; min-height:44px; font-size:14px; font-weight:bold; cursor:pointer; }
            .contact-detail-delete-btn { background:#dc2626; color:yellow; border:none; border-radius:9px; min-height:44px; font-size:14px; font-weight:bold; cursor:pointer; }
            .contact-project-button { width:100%; border:1px solid #c3d2e3; border-radius:10px; padding:8px; margin-top:6px; background:#ffffff; text-align:center; cursor:pointer; }
            .contact-project-title { color:#003b73; font-size:14px; font-weight:bold; margin-bottom:2px; text-align:center; }
        ...
        <div id="contacts-list-view" class="contacts-card">
            ...
            <div class="contacts-version-tag">facilities_views/facilities-contacts/grid.js</div>
        </div>
    ...
    async function showContactDetail(contact) {
        ...
        detailView.innerHTML = `
            ...
            <!-- COMPACT CONTACT DETAIL INFO BLOCK - START -->
            <div style="margin-bottom:10px;text-align:center;">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px;font-size:21px;font-weight:bold;color:#111827;line-height:1.1;">
                    <div>${escapeHtml(contact.name || '')}</div>
                    <div>${escapeHtml(contact.role || '')}</div>
                </div>

                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px;font-size:15px;font-weight:bold;line-height:1.1;">
                    <div>
                ...
                <div style="font-size:15px;margin-bottom:3px;line-height:1.15;">
                    ${escapeHtml(contact.address || '')}
                </div>

                <div style="font-size:15px;color:#444;line-height:1.15;">
                    ${escapeHtml(contact.notes || '')}
                </div>
            </div>
            <!-- COMPACT CONTACT DETAIL INFO BLOCK - END -->
