...
export async function renderFacilityProjectDetailGrid(containerId, context = {}) {
    ...
    container.innerHTML = `
        <style>
            ...
            .project-update-list-item { border-top:1px solid #d6dee8; padding-top:8px; margin-top:8px; }
            ...
            .project-update-modal select { width:100%; padding:9px; border:1px solid #bbb; border-radius:6px; font-size:15px; box-sizing:border-box; }
